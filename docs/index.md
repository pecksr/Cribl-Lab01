...
Note: no data has been storage on Cribl Stream. 
...
A new context window will present you a selection to choose how to process the data in this connected route. Click on Passthru (sending raw data to the destination, no pipelines applied) click save.
...
7.  Analyze results on Splunk or Elastic (no dashboards provided for this part)
